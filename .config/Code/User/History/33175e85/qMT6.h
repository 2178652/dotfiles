...
/**
 * Function added by Charles to this existing component
 * @brief Sends a scrolling banner to the LCD
 * 
 * @param text The string to send to the LCD
 * @param row The row on the lcd where the message will displayed
 * @param delay_ms The delay between each new caracter
 * This function sends a null-terminated string to the LCD to be displayed.
 */
